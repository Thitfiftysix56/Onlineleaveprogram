...
source = Path(r"C:\Users\User\Desktop\online-leavesystem\.codex-docx-final-requirement\reference-render")
...
for start in range(0, len(pages), 4):
    ...
    canvas.save(target / f"pages-{start + 1:02d}-{start + len(batch):02d}.jpg", quality=88)
