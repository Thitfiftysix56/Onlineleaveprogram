...
const auditTitles = {
  ...
  password_reset_otp_failed: 'ยืนยันรหัส OTP ไม่สำเร็จ',
  ...
  update_employee_status: 'เปลี่ยนสถานะพนักงาน',
  delete_employee: 'ลบพนักงาน',
  create_department: 'เพิ่มแผนก',
  update_department: 'แก้ไขแผนก',
  update_department_status: 'เปลี่ยนสถานะแผนก',
  delete_department: 'ลบแผนก',
  create_position: 'เพิ่มตำแหน่ง',
  update_position: 'แก้ไขตำแหน่ง',
  update_position_status: 'เปลี่ยนสถานะตำแหน่ง',
  delete_position: 'ลบตำแหน่ง',
  create_leave_type: 'เพิ่มประเภทการลา',
  update_leave_type: 'แก้ไขประเภทการลา',
  update_leave_type_status: 'เปลี่ยนสถานะประเภทการลา',
  delete_leave_type: 'ลบประเภทการลา',
  create_leave_entitlement: 'เพิ่มสิทธิ์การลา',
  update_leave_entitlement: 'แก้ไขสิทธิ์การลา',
  update_entitlement: 'แก้ไขสิทธิ์การลา',
  create_holiday: 'เพิ่มวันหยุด',
  update_holiday: 'แก้ไขวันหยุด',
  delete_holiday: 'ลบวันหยุด',
  save_leave_draft: 'บันทึกร่างคำขอลา',
  delete_leave_draft: 'ลบร่างคำขอลา',
  submit_leave: 'ส่งคำขอลา',
  create_leave: 'สร้างคำขอลา',
  approve_leave: 'อนุมัติคำขอลา',
  reject_leave: 'ปฏิเสธคำขอลา',
  cancel_leave: 'ยกเลิกคำขอลา',
  upload_attachment: 'อัปโหลดไฟล์แนบคำขอลา',
  delete_attachment: 'ลบไฟล์แนบคำขอลา',
